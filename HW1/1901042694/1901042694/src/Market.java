public class Market extends Buildings  {
    ...
    public String toString() {
        return String.format("Market "+"Openning Time "+openningTime+ " Closing Time "+closingTime+" Length "+ this.getLength()+" Height "+getHeight()+" Position "+position+" Owner "+getOwner()+"\n");
    }
