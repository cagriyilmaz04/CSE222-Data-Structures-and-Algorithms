...
public class Street implements EditingMode,ViewingMode{
    ...
    private ArrayList<Playground> data ;
    int used=0;

    public Street(){
        ArrayList<Playground> newList = new ArrayList<>();
        data=newList;
    ...
    public ArrayList<Playground> getData() {
        return data;
    }
    public void setData(ArrayList<Playground> data) {
        this.data = data;
    }
