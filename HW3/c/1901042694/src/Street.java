...
public class Street implements EditingMode,ViewingMode{
    ...
    private LDLinkedList<Playground> data ;
    int used=0;

    public Street(){
        LDLinkedList<Playground> newList = new LDLinkedList<Playground>();
        data=newList;
    }
    ...
    public void add(Playground item) throws Exception {
        ...
        if(item.position>= Length){
            ...
            if(used==0){
                ...
                LDLinkedList<Playground> data1=new LDLinkedList<Playground>() ;
                LDLinkedList<Playground>data2=new LDLinkedList<Playground>() ;
                if(used==1){
    ...
    public void View() {
        ...
        try {
           ...
           System.out.println(this.toString());
            ...
            System.out.println("B "+e.getLocalizedMessage()+ " A ");

        }


    }
    public LDLinkedList<Playground> getData() {
        return data;
    }
    public void setData(LDLinkedList<Playground> data) {
        this.data = data;
    }
