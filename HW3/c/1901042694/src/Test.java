    ...
    private static void QuickExample() {
        ...
        LakeStreet.setLength(50);
                ...
                try {
                    ...
                    House gokhan=new House(20,10,10,"Gokhan Digircibasi","Yellow",20,1,LakeStreet);
                    LakeStreet.add(gokhan);

                    LakeStreet.add(new Office("Pharmacy",10,10,"Omer Faruk Istemihan",17,1,LakeStreet));

                    Market roha=new Market(8,20,10,10,"Atakan Yilmaz",35,2,LakeStreet);
                    LakeStreet.add(roha);
