...
public class Basket {
    ...
    public void displayBasket() {
        ...
        for (int i = 0; i < 999; i++) {
            if (myBasketArray[i] != null) {
                java.lang.System.out.println("Name: " + myBasketArray[i].getName() + " Price " + myBasketArray[i].getPrice()  + " Restaurant:" + myBasketArray[i].getName());
            }
    ...
    public String toString() {
        ...
        while (foodIterator.hasNext()){
            returnedValue.append(foodIterator.next().toString());
        }
